      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/20 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-semibold italic bg-gradient-to-r from-amber-400 to-yellow-600 bg-clip-text text-transparent" style={{ fontFamily: "'Playfair Display', serif" }}>
              The Ambitions
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center justify-center mb-12">
              <Badge className="relative px-8 py-3 text-lg font-bold bg-gradient-to-r from-[#1a5ee9] to-[#3d8bfd] text-white border-0 shadow-xl shadow-[#1a5ee9]/30">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 sm:mb-6" style={{ lineHeight: '0.85' }}>
              <span className="font-serif italic bg-gradient-to-r from-amber-300 via-amber-400 to-yellow-500 bg-clip-text text-transparent" style={{ fontFamily: "'Playfair Display', serif" }}>
                The Ambitions
              </span>
              <br />
          ...
          {/* Statistics Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 mb-20 sm:mb-32 px-4 sm:px-0">
            {/* Waitlist Count */}
            <AnimateOnScroll delay={0.3}>
              <Card className="backdrop-blur-xl bg-gradient-to-br from-[#1a5ee9]/10 to-[#3d8bfd]/5 border-[#1a5ee9]/20 rounded-2xl sm:rounded-3xl overflow-hidden h-full">
                <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-center">
                  <div className="text-center">
                    <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1a5ee9] mb-2 sm:mb-3">{waitlistCount.toLocaleString()}+</div>
                    <div className="text-gray-400 text-sm sm:text-base">Waitlist</div>
                  </div>
                </CardContent>
              </Card>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll delay={0.4}>
              <Card className="backdrop-blur-xl bg-gradient-to-br from-green-500/10 to-emerald-500/5 border-green-500/20 rounded-2xl sm:rounded-3xl overflow-hidden h-full">
                <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-center">
                  <div className="text-center">
                    <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-green-400 mb-2 sm:mb-3">{signalsProcessed.toLocaleString()}</div>
                    <div className="text-gray-400 text-sm sm:text-base">Signals</div>
                  </div>
                </CardContent>
              </Card>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll delay={0.5}>
              <Card className="backdrop-blur-xl bg-gradient-to-br from-amber-500/10 to-orange-500/5 border-amber-500/20 rounded-2xl sm:rounded-3xl overflow-hidden h-full">
                <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-center">
                  <div className="text-center">
                    <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-amber-300 mb-2 sm:mb-3">{successRate}%</div>
            ...
            <AnimateOnScroll delay={0.6}>
              <Card className="backdrop-blur-xl bg-gradient-to-br from-purple-500/10 to-pink-500/5 border-purple-500/20 rounded-2xl sm:rounded-3xl overflow-hidden h-full">
                <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-center">
                  <div className="text-center">
                    <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-purple-400 mb-2 sm:mb-3">{activeUsers}</div>
                    <div className="text-gray-400 text-sm sm:text-base">Beta Users</div>
                  </div>
                </CardContent>
              </Card>
            </AnimateOnScroll>
